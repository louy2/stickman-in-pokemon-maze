...
const BOSS_DATA = {
    ...
    chapter1: [
        {
            floor: 10,
            id: 401, name: "锁链史莱姆", emoji: "🟢", type: "boss",
            hp: 350, attack: 32, defense: 25, exp: 200, gold: 100,
            isBossStairs: true,
            dialogues: [
                "咕噜...咕噜...",
                "*铁链哗哗作响*",
            ...
            phases: [
                {
                    ...
                    hpThreshold: 1.0,
                    attacks: [
                        { name: "跳跃攻击", damage: 1.3, message: "⬆️ 史莱姆高高跃起，重重砸下！地面裂开了！" },
                        { name: "粘液喷射", damage: 1.0, message: "史莱姆喷出腐蚀性粘液！" },
                        { name: "铁链横扫", damage: 1.2, message: "⛓️ 锁链史莱姆甩动铁链横扫！" }
                    ],
                    phaseMessage: "⛓️ 锁链史莱姆拖着沉重的铁链，准备战斗！"
                },
                {
                    name: "火焰觉醒",
                    hpThreshold: 0.6,
                    attacks: [
                        { name: "烈焰跳跃", damage: 1.8, effect: "burn", message: "🔥⬆️ 史莱姆全身燃起火焰，猛烈跃起砸下！！" },
                        { name: "火焰喷射", damage: 1.5, message: "🔥 史莱姆喷出灼热的火焰！" },
                        { name: "燃烧铁链", damage: 1.6, effect: "burn", message: "🔥⛓️ 铁链被火焰包裹，如烈焰之鞭抽来！" },
                        { name: "烈焰跳压", damage: 2.0, effect: "burn", message: "🔥⬆️💥 史莱姆蓄力跳跃！燃烧的身躯从天而降！！！" }
                    ],
                    phaseMessage: "🔥 史莱姆的身体开始剧烈燃烧！粘液化为岩浆！铁链被烧得通红！"
                },
                {
                    name: "挣脱锁链",
                    hpThreshold: 0.3,
                    attacks: [
                        { name: "狂暴跳跃", damage: 2.2, message: "💥⬆️ 脱链的史莱姆疯狂跳跃！大地在颤抖！" },
                        { name: "火焰爆发", damage: 2.5, effect: "burn", message: "🔥💥 史莱姆爆发出毁灭性的火焰风暴！" },
                        { name: "分裂再生", damage: 0, effect: "heal", value: 50, message: "史莱姆分裂出一小块，吸收后恢复了体力！" },
                        { name: "自由冲撞", damage: 2.0, ignoreDefense: true, message: "💥 脱离锁链的史莱姆全力冲撞！无法防御！" }
                    ],
                    phaseMessage: "💥⛓️ 铁链断裂了！！！史莱姆获得了自由，变得无比狂暴！！！"
                }
            ],
            specialAttacks: [
                { name: "跳跃攻击", damage: 1.3, message: "⬆️ 史莱姆高高跃起，重重砸下！" },
                { name: "铁链横扫", damage: 1.2, message: "⛓️ 锁链史莱姆甩动铁链横扫！" }
            ],
            intro: "一阵沉重的铁链碰撞声回荡在走廊中...一个被锁链束缚的巨大史莱姆挡在楼梯前！"
        },
        {
            floor: 20,
